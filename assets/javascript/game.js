...
function reset() {
	window.gameObj = {
		...
		jediMaster: false,
		characterArrayList: [
	    // 1.  An array or object of possible characters with properties thst would included: 
	    ...
	    {
	        name: 'Kylo Wren',
	        visual: 'assets/images/kylowren.png',
	        healthPoints: 110,
	        attackPower: 12,
	        counterAttackPower: 20,
	    },
	...
	// create an array of battle sounds
		battleSoundsArray: ['assets/audio/saberclash.mp3'],
